...
<div id="body">
	...
	<div class="slide">
		...
		<ul>
			...
			?>
			<a href="#" onclick="window.open('open_img.php?img_name=<?echo $room['r_photo']; ?>', '_blank', 'width=<?echo $img_width; ?>, height=<?echo $img_height; ?>')"><img src="<?echo $img; ?>" width="600" height="400" alt="썸네일" /></a>
			</li>
			<?
			if($room['r_photo_k']) {
			//이미지 사이즈
			...
			?>
			<li>
			<a href="#" onclick="window.open('open_img.php?img_name=<?echo $room['r_photo_k'];?>', '_blank', 'width=<?echo $img_width; ?>, height=<?echo $img_height; ?>')"><img src="../roomimg/<?echo $room['r_photo_k']; ?>" width="600" height="400" alt="부엌사진" /></a>
			</li>
			<?
			}
			if($room['r_photo_b']) {
			...
			?>
			<li>
			<a href="#" onclick="window.open('open_img.php?img_name=<?echo $room['r_photo_b'];?>', '_blank', 'width=<?echo $img_width; ?>, height=<?echo $img_height; ?>')"><img src="../roomimg/<?echo $room['r_photo_b']; ?>" width="600" height="400" alt="욕실사진" /></a>
			</li>
			<?
			}
			if($room['r_photo_r']) {
			...
			?>
			<li>
			<a href="#" onclick="window.open('open_img.php?img_name=<?echo $room['r_photo_r'];?>', '_blank', 'width=<?echo $img_width; ?>, height=<?echo $img_height; ?>')"><img src="../roomimg/<?echo $room['r_photo_r']; ?>" width="600" height="400"  alt="기타사진" /></a>
			</li>
			<?
			}
			?>
	...
	<div id="content">
		...
		<table width="100%" cellpadding="15" cellspacing="0">
			...
			<tr>
				...
				<td>
				<?
				if($room['midnight'] == "y") { $k=1; echo "※심야 보일러 "; }
				if($room['r_tax_gas'] == "y") { $k=1; echo "가스세  "; }
				if($room['r_tax_boiler'] == "y") { $k=1; echo "보일러세  "; }
				if($room['r_tax_elec'] == "y") { $k=1; echo "전기세  "; }
				if($room['r_tax_water'] == "y") { $k=1; echo "수도세  "; }
				if($room['r_tax_internet'] == "y") { $k=1; echo "인터넷  "; }
				if($k == 0) echo "입력안함";
				?>
				</td>
			</tr>
		...
		<div id="content_map_title">
			<span style="font-size:20pt; color:#333; font-weight:500;">위치 정보</span>
		</div>
		</br>
		<div id="content_map" style="width: 100%; height: 500px;">
			<?include "content_map.php"; ?>
		</div>
	</div>
</div>
</div>
