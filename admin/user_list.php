...
<div id="body">
	<div id="body_title">
		<span class="body_title_f">▶</span> 회원 등록관리
	</div>
	<input style="height:30px;width:150px;border: 0px;background-color: #ff6633;font-size: 13pt;color: #fff;" type="button" onclick="window.location='user_regi.php'" value="회원 등록하기" /><br/>
	...
	<?
	$i = 1;
	$query_a = mysql_query("select * from user");
	...
	<tr>
		...
		<input style="height:20px;width:60px;border: 0px;background-color: #999999;font-size: 9pt;color: #fff;" type="button" onClick="if (confirm('삭제하시겠습니까?')) location.href='user_delete.php?u_id=<?echo $user_a['u_id']; ?>'" value="삭제" />&nbsp;&nbsp;
		</td>
	</tr>
	<tr>
		<td colspan="9" style="text-align:left;">
