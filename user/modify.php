...
<div id="body">
	<div id="user_modify">
	<form name="modify" id="modify" action="modify_ok.php" method="post">
	<input type="hidden" name="type" value="s" />
		<table width="100%" border="0" cellpadding="10">
			<tr>
				<td width="80"><span class="font_user_modify_a">아이디</span></td>
				<td><input style="background-color:#eee;" type="text" name="u_id" id="u_id" readonly value="<?echo $user['u_id']; ?>" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input style="background-color:#eee;" type="text" size="10" name="u_name" id="u_name" readonly value="<?echo $user['u_name']; ?>" /></td>
			</tr>
			<tr>
				<td><span class="font_user_modify_a">이메일</span></td>
				<td><input type="text" size="30" name="u_email" id="u_email" value="<?echo $user['u_email']; ?>" /></td>
			</tr>
			<tr>
				<td><span class="font_user_modify_a">연락처</span>	</td>
				<td><input type="text" name="u_phone" id="u_phone" value="<?echo $user['u_phone']; ?>" onkeyup="digitCheck()" /></td>
			</tr>
		</table><br /><br />
